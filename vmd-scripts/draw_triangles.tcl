...
# set res 16
  ...
  puts "Drawing $ncopies copies"
    ...
    draw_triangle $molid $startidx red $res

		set startidx [expr $i * $natomspercopy + 3]
    draw_triangle $molid $startidx cyan $res

		set startidx [expr $i * $natomspercopy + 6]
    draw_triangle $molid $startidx cyan $res

		set startidx [expr $i * $natomspercopy + 9]
    draw_triangle $molid $startidx red $res
	}
}
